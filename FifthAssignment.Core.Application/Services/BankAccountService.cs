...
namespace FifthAssignment.Core.Application.Services
{
	internal class BankAccountService : BaseProductService<BankAccountModel, SaveBankAccountModel, BankAccount>, IBankAccountService
	{
		...
		public BankAccountService(IBankAccountRepository bankAccountRepository, IMapper mapper, IHttpContextAccessor httpContext, IOptions<SessionKeys> sessionKeys) : base(bankAccountRepository, mapper)
		{
