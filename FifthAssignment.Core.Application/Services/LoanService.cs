...
namespace FifthAssignment.Core.Application.Services
{
	public class LoanService : BaseProductService<LoanModel, SaveLoanModel, Loan>, ILoanService
	{
		...
		public LoanService(ILoanRepository loanRepository, IMapper mapper, IHttpContextAccessor httpContext, IOptions<SessionKeys> sessionKeys) : base(loanRepository, mapper)
		{
