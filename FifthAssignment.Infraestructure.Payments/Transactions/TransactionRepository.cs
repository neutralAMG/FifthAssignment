...
namespace FifthAssignment.Infraestructure.Transaction.Repositories
{
	public class TransactionRepository : BasePaymentRepository<FifthAssignment.Core.Domain.Entities.PaymentContext.Transaction>, ITransactionRepository
	{
		...
		public TransactionRepository(PaymentContext context) : base(context)
		{
			_context = context;
		}
		...
		public async Task<bool> UpdateAsync(Core.Domain.Entities.PaymentContext.Transaction transaction)
		{
			try
			{
